...
class SubscriptionsTest < ApplicationSystemTestCase
  ...
  test "creating a Subscription" do
    ...
    fill_in "Address", with: @subscription.address
    fill_in "Classcourse", with: @subscription.classcourse_id
    fill_in "Description", with: @subscription.description
    fill_in "Email", with: @subscription.email
    fill_in "Literary Habilitation", with: @subscription.literary_habilitation
    fill_in "Name", with: @subscription.name
    fill_in "Phone Number", with: @subscription.phone_number
